...
if( ! function_exists( 'seva_lite_getting_started_menu' ) ) :
/**
 * Adding Getting Started Page in admin menu
 */
function seva_lite_getting_started_menu(){	
	add_theme_page(
		__( 'Getting Started', 'seva-lite' ),
		__( 'Getting Started', 'seva-lite' ),
		'manage_options',
		'seva-lite-getting-started',
		'seva_lite_getting_started_page'
	);
}
endif;
add_action( 'admin_menu', 'seva_lite_getting_started_menu' );

if( ! function_exists( 'seva_lite_getting_started_admin_scripts' ) ) :
/**
 * Load Getting Started styles in the admin
 */
function seva_lite_getting_started_admin_scripts( $hook ){
	// Load styles only on our page
	if( 'appearance_page_seva-lite-getting-started' != $hook ) return;

    wp_enqueue_style( 'seva-lite-getting-started', get_template_directory_uri() . '/inc/getting-started/css/getting-started.css', false, SEVA_LITE_THEME_VERSION );
    
    wp_enqueue_script( 'plugin-install' );
    wp_enqueue_script( 'updates' );
    wp_enqueue_script( 'seva-lite-getting-started', get_template_directory_uri() . '/inc/getting-started/js/getting-started.js', array( 'jquery' ), SEVA_LITE_THEME_VERSION, true );
    wp_enqueue_script( 'seva-lite-recommended-plugin-install', get_template_directory_uri() . '/inc/getting-started/js/recommended-plugin-install.js', array( 'jquery' ), SEVA_LITE_THEME_VERSION, true );    
    wp_localize_script( 'seva-lite-recommended-plugin-install', 'seva_lite_start_page', array( 'activating' => __( 'Activating ', 'seva-lite' ) ) );
}
endif;
add_action( 'admin_enqueue_scripts', 'seva_lite_getting_started_admin_scripts' );

if( ! function_exists( 'seva_lite_call_plugin_api' ) ) :
/**
 * Plugin API
**/
function seva_lite_call_plugin_api( $plugin ) {
...
if( ! function_exists( 'seva_lite_check_for_icon' ) ) :
/**
 * Check For Icon 
**/
function seva_lite_check_for_icon( $arr ) {
	if( ! empty( $arr['svg'] ) ){
...
if( ! function_exists( 'seva_lite_getting_started_page' ) ) :
/**
 * Callback function for admin page.
*/
function seva_lite_getting_started_page(){ ?>
	<div class="wrap getting-started">
		<h2 class="notices"></h2>
		<div class="intro-wrap">
			<div class="intro">
				<h3><?php printf( esc_html__( 'Getting started with %1$s v%2$s', 'seva-lite' ), SEVA_LITE_THEME_NAME, SEVA_LITE_THEME_VERSION ); ?></h3>
				<h4><?php printf( esc_html__( 'You will find everything you need to get started with %1$s below.', 'seva-lite' ), SEVA_LITE_THEME_NAME ); ?></h4>
			</div>
		</div>
			...
			<ul class="inline-list">
				<li class="current">
                    <a id="plugins" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Recommended Plugins', 'seva-lite' ); ?>
                    </a>
                </li>
				<li>
                    <a id="help" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Getting Started', 'seva-lite' ); ?>
                    </a>
                </li>
				<li>
                    <a id="support" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'FAQ\'s &amp; Support', 'seva-lite' ); ?>
                    </a>
                </li>
				<li>
                    <a id="free-pro-panel" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Free Vs Pro', 'seva-lite' ); ?>
                    </a>
                </li>
			</ul>
