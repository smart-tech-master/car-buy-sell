<?php
/**
 * Seva Lite Customizer Slider Control.
 * 
 * @package Seva_Lite
*/
...
if ( ! class_exists( 'Seva_Lite_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Seva_Lite_Slider_Control extends WP_Customize_Control {

		public $type = 'seva-lite-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'seva-lite-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'seva-lite-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
