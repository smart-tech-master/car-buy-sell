...
$wp_customize->add_section( 'section_blog',
	array(
		'title'      => __( 'Latest Posts', 'soft-business' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[enable_blog_section]', 
	array(		
	'label' 	=> __('Enable Latest Posts Section', 'soft-business'),
...
$wp_customize->add_control('theme_options[blog_section_title]', 
	array(
	'label'       => __('Section Title', 'soft-business'),
	'section'     => 'section_blog',   
	'settings'    => 'theme_options[blog_section_title]',	
	'active_callback' => 'soft_business_blog_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control( 'theme_options[blog_number]',
	array(
		'label'       		=> __( 'Number of Posts', 'soft-business' ),
...
$blog_number = soft_business_get_option( 'blog_number' );
...
$wp_customize->add_control(
	new soft_business_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[blog_category]',
		array(
		'label'    => __( 'Select Category', 'soft-business' ),
		'section'  => 'section_blog',
