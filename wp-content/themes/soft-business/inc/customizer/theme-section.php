...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'soft-business' ),
	'priority'   => 100,
...
'title'       => __('Layout Option', 'soft-business'),
...
$wp_customize->add_control(new soft_business_Image_Radio_Control($wp_customize, 'theme_options[layout_options_blog]', 
	array(		
	'label' 	=> __('Blog Layout', 'soft-business'),
...
$wp_customize->add_control(new soft_business_Image_Radio_Control($wp_customize, 'theme_options[layout_options_archive]', 
	array(		
	'label' 	=> __('Archive Layout', 'soft-business'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new soft_business_Image_Radio_Control($wp_customize, 'theme_options[layout_options_page]', 
	array(		
	'label' 	=> __('Page Layout', 'soft-business'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new soft_business_Image_Radio_Control($wp_customize, 'theme_options[layout_options_single]', 
	array(		
	'label' 	=> __('Single Post Layout', 'soft-business'),
	'section' 	=> 'section_general',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Excerpt Length', 'soft-business'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[excerpt_length]', array(
	'label'       => __( 'Excerpt Length', 'soft-business' ),
	'description' => __( 'in words', 'soft-business' ),
...
$wp_customize->add_section('section_blog_title', 
	array(    
	'title'       => __('Blog Title', 'soft-business'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[your_latest_posts_title]',
	array(
	'label'    => __( 'Blog Title', 'soft-business' ),
...
$wp_customize->add_section('section_read_more', 
	array(    
	'title'       => __('Read More Text', 'soft-business'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'theme_options[readmore_text]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'soft_business_sanitize_textarea_content',
	'transport'         => 'refresh',
	)
);
$wp_customize->add_control( 'theme_options[readmore_text]',
	array(
	'label'    => __( 'Read More Text', 'soft-business' ),
...
$wp_customize->add_section('section_footer', 
	array(    
	'title'       => __('Footer Setting', 'soft-business'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => __( 'Copyright Text', 'soft-business' ),
...
$wp_customize->add_control( 'theme_options[enable_frontpage_content]', array(
	'label'       	=> __( 'Enable Content', 'soft-business' ),
	'description' 	=> __( 'Click to enable content on static front page only.', 'soft-business' ),
