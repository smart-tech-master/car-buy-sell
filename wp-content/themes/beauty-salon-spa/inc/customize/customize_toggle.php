 ...
 * @access public
 */
class Beauty_Salon_Spa_Toggle_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'beauty-salon-spa-toggle-control-styles', get_parent_theme_file_uri( 'assets/css/toggle.css' ), false, '1.0.0', 'all' );
	}
