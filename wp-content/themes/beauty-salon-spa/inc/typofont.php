...
function beauty_salon_spa_custom_styles($custom) {
	...
	wp_add_inline_style( 'beauty-salon-spa-style', $custom );

}
add_action( 'wp_enqueue_scripts', 'beauty_salon_spa_custom_styles' );

//Sanitizes Fonts
function beauty_salon_spa_sanitize_fonts( $input ) {
	$valid = array(
		'' => 'Select',
