...
<?php
	$post_sidebar = get_theme_mod( 'beauty_salon_spa_post_sidebar' );
...
<main id="content" class="mt-5">
	<div class="container">
		...
		<?php else : ?>
			<header class="page-header">
				<h2 class="page-title"><span><?php esc_html_e( 'Posts', 'beauty-salon-spa' ); ?></span></h2>
			</header>
		<?php endif; ?>
				    		...
				    		<div class="row">
								<?php
									...
									while ( have_posts() ) : the_post();
										...
										$post_option = get_theme_mod( 'beauty_salon_spa_post_option','simple_post');
