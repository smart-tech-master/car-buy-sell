...
<?php $post_option = get_theme_mod( 'beauty_salon_spa_grid_column','3_column');
			...
			<div class="postbox smallpostimage p-2 mb-3">
	        	...
	        	<div class="overlay pt-2 text-center">
	        		<div class="date-box mb-2">
	        			<?php if( get_theme_mod('beauty_salon_spa_date',true) != ''){ ?>
	        				<span class="mr-2"><i class="far fa-calendar-alt mr-2"></i><?php the_time( get_option( 'date_format' ) ); ?></span>
	        			<?php } ?>
	        			<?php if( get_theme_mod('beauty_salon_spa_admin',true) != ''){ ?>
	        			...
	        			<?php }?>
	        			<?php if( get_theme_mod('beauty_salon_spa_comment',true) != ''){ ?>
	      					<span class="entry-comments"><i class="fas fa-comments mr-2"></i> <?php comments_number( __('0 Comments','beauty-salon-spa'), __('0 Comments','beauty-salon-spa'), __('% Comments','beauty-salon-spa')); ?></span>
	      				<?php }?>
	    			</div>
	        		<p><?php the_excerpt();?></p>
	        	</div>
