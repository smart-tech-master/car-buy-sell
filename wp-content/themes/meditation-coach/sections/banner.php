...
$read_more                  = get_theme_mod( 'slider_readmore', __( 'Read More', 'meditation-coach' ) );
$banner_title               = get_theme_mod( 'banner_title', __( 'Let\'s Build your Dream life together', 'meditation-coach' ) );
$banner_subtitle            = get_theme_mod( 'banner_subtitle', __( 'Welcome', 'meditation-coach' ) );
$banner_content             = get_theme_mod( 'banner_content', __( 'To empower women to make a positive impact on the world with fiery passion, unbridled self-belief, and head-turning style.', 'meditation-coach' ) );
$banner_label               = get_theme_mod( 'banner_label', __( 'GET STARTED', 'meditation-coach' ) );
$banner_link                = get_theme_mod( 'banner_link', '#' );
$banner_caption_layout      = get_theme_mod( 'banner_caption_layout', 'left' );
$cta_layout                 = get_theme_mod( 'banner_layout', 'six' );

if( $ed_banner == 'static_banner' && has_custom_header() ){ ?>
    <div id="banner_section" class="site-banner static-cta style-<?php echo esc_attr( $cta_layout ); ?><?php if( has_header_video() ) echo esc_attr( ' video-banner' ); ?>">

        <?php if($cta_layout == 'six') echo '<div class="container">'; ?>
        ...
        <?php if($cta_layout == 'six') echo '</div>'; ?>
    </div>
<?php
