 ...
 * @access public
 */
final class Author_Personal_Blog_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'Author_Personal_Blog_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new Author_Personal_Blog_Customize_Section_Pro(
				$manager,
				'go-pro',
				array(
					'priority'       => 1,
					'pro_text' => esc_html__( 'Upgrade To Pro', 'author-personal-blog' ),
					'pro_url'  => 'https://rswpthemes.com/author-personal-blog-pro-wordpress-theme/',
				)
			)
		);
	}
...
Author_Personal_Blog_Customize::get_instance();
