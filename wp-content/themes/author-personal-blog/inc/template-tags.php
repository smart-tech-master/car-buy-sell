...
function author_personal_blog_theme_by(){
	...
	<div class="theme-by-wrapper">
		<div class="theme-by-inner">
			<strong><?php esc_html_e( 'Theme: ', 'author-personal-blog' );?></strong><a href="<?php echo esc_url('https://rswpthemes.com/author-personal-blog-wordpress-theme/');?>"><?php esc_html_e( 'Author Personal Blog WordPress Theme', 'author-personal-blog' );?></a>
		</div>
	</div>
	<?php
}