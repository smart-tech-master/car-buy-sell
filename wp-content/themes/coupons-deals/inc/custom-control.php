...
class Coupons_Deals_Custom_Control extends WP_Customize_Control {
...
class Coupons_Deals_Image_Radio_Control extends WP_Customize_Control {
    public function render_content() {
        ...
        <ul class="controls" id='coupons-deals-img-container'>
            <?php
            foreach ($this->choices as $value => $label) :
                $class = ($this->value() == $value) ? 'coupons-deals-radio-img-selected coupons-deals-radio-img-img' : 'coupons-deals-radio-img-img';
                ?>
