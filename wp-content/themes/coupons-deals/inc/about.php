...
class Coupons_Deals_About_Widget extends WP_Widget {
	function __construct() { parent::__construct( 
		'Coupons_Deals_About_Widget',__('About us', 'coupons-deals'),
			array( 'description' => __( 'Display short information about yourself in sidebar or in footer of your website.', 'coupons-deals' ), )
		);
	}
		...
		<div class="widget">
	        ...
	        echo '<div class="custom-about-us">';
		        ...
		        <div class="about-social_links text-center">
			        <?php if(!empty($facebook) ){ ?><a href="<?php echo esc_url($instance['facebook']); ?>"><i class="fab fa-facebook-f me-2"></i><span class="screen-reader-text"><?php esc_html_e( 'Facebook','coupons-deals' );?></span></a><?php } ?>
	        		<?php if(!empty($twitter) ){ ?><a href="<?php echo esc_url($instance['twitter']); ?>"><i class="fab fa-twitter me-2"></i><span class="screen-reader-text"><?php esc_html_e( 'Twitter','coupons-deals' );?></span></a><?php } ?>
					<?php if(!empty($linkedin) ){ ?><a href="<?php echo esc_url($instance['linkedin']); ?>"><i class="fab fa-linkedin-in me-2"></i><span class="screen-reader-text"><?php esc_html_e( 'Linkedin','coupons-deals' );?></span></a><?php } ?>
					<?php if(!empty($pinterest) ){ ?><a href="<?php echo esc_url($instance['pinterest']); ?>"><i class="fab fa-pinterest-p me-2"></i><span class="screen-reader-text"><?php esc_html_e( 'Pinterest','coupons-deals' );?></span></a><?php } ?>
					<?php if(!empty($instagram) ){ ?><a href="<?php echo esc_url($instance['instagram']); ?>"><i class="fab fa-instagram me-2"></i><span class="screen-reader-text"><?php esc_html_e( 'Instagram','coupons-deals' );?></span></a><?php } ?>
				</div>
	...
	public function form( $instance ) {
		...
		<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','coupons-deals'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','coupons-deals'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('facebook')); ?>"><?php esc_html_e('Facebook:','coupons-deals'); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id('facebook')); ?>" name="<?php echo esc_attr($this->get_field_name('facebook')); ?>" type="text" value="<?php echo esc_attr($facebook); ?>">
		</p>
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('twitter')); ?>"><?php esc_html_e('Twitter:','coupons-deals'); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id('twitter')); ?>" name="<?php echo esc_attr($this->get_field_name('twitter')); ?>" type="text" value="<?php echo esc_attr($twitter); ?>">
		</p>
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('linkedin')); ?>"><?php esc_html_e('Linkedin:','coupons-deals'); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id('linkedin')); ?>" name="<?php echo esc_attr($this->get_field_name('linkedin')); ?>" type="text" value="<?php echo esc_attr($linkedin); ?>">
		</p>
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('instagram')); ?>"><?php esc_html_e('Instagram:','coupons-deals'); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id('instagram')); ?>" name="<?php echo esc_attr($this->get_field_name('instagram')); ?>" type="text" value="<?php echo esc_attr($instagram); ?>">
		</p>
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('pinterest')); ?>"><?php esc_html_e('Pinterest:','coupons-deals'); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id('pinterest')); ?>" name="<?php echo esc_attr($this->get_field_name('pinterest')); ?>" type="text" value="<?php echo esc_attr($pinterest); ?>">
		</p>
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','coupons-deals'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','coupons-deals'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','coupons-deals'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function coupons_deals_about_custom_load_widget() {
	register_widget( 'Coupons_Deals_About_Widget' );
}
add_action( 'widgets_init', 'coupons_deals_about_custom_load_widget' );