<?php
/**
 * Blossom Studio Plugin Recommend Control
 * 
...
if( ! class_exists( 'blossom_studio_Plugin_Install_Helper' ) ){
	return;
}
 ...
 */
class Blossom_Studio_Plugin_Recommend_Control extends WP_Customize_Control {
