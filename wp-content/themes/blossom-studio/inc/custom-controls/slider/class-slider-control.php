<?php
/**
 * Blossom Studio Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Blossom_Studio_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Blossom_Studio_Slider_Control extends WP_Customize_Control {

		public $type = 'blossom-studio-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'blossom-studio-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'blossom-studio-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
