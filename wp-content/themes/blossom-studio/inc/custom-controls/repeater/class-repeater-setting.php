<?php
/**
 * Blossom Studio Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Studio_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Studio_Repeater_Setting extends WP_Customize_Setting {
