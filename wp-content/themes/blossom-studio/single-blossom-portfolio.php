...
$related_image_size = ( $portfolio_crop ) ? 'full' : 'blossom-studio-single';
...
while ( have_posts() ) : the_post();
    ...
    $related_title = get_theme_mod( 'related_portfolio_title', __( 'Related Projects', 'blossom-studio' ) );
