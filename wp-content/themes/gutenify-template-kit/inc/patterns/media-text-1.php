	...
	<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column is-vertically-aligned-center"
					...
					<div class="wp-block-group alignwide">
							...
							<p class="has-small-font-size"><?php echo esc_html__( 'Full Site Editing Theme ( FSE ) With Multiple Kits', 'gutenify-template-kit' ); ?></p>
							<!-- /wp:paragraph -->

							<!-- wp:heading {"fontSize":"huge"} -->
							<h2 class="has-huge-font-size"><?php echo esc_html__( 'Meet Gutenify Template Kit – Powerful Block theme', 'gutenify-template-kit' ); ?></h2>
							<!-- /wp:heading -->
							...
							<div class="wp-block-buttons" style="margin-top:20px;margin-bottom:20px">
									...
									<div class="wp-block-button is-style-fill"><a class="wp-block-button__link"
													href="#" style="border-radius:0px"><?php echo esc_html__( 'More Demo', 'gutenify-template-kit' ); ?></a></div>
									<!-- /wp:button -->
							</div>
							<!-- /wp:buttons -->
					</div>
