        ...
        <div class="wp-block-column" style="padding-top:20px;padding-bottom:20px">
            ...
            <div class="wp-block-group">
                ...
                <div class="wp-block-group">
                    ...
                    <!-- wp:paragraph -->
                    <p><a href="#"><?php echo esc_html__( 'gutenify@companyname.com', 'gutenify-template-kit' ); ?></a></p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
...
<div class="wp-block-group has-background-color has-foreground-background-color has-text-color has-background has-link-color"
    ...
    <div class="wp-block-group alignwide">
		...
		'<a href="' . esc_url( __( 'https://gutenify.com/themes/gutenify-template-kit', 'gutenify-template-kit' ) ) . '" rel="nofollow" target="_blank">Gutenify Template Kit</a>',
