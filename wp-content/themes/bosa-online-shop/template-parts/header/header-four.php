<header id="masthead" class="site-header header-four">
	<div class="top-header">
		...
		<?php if( !get_theme_mod( 'disable_mobile_top_header', false ) ){ ?>
			<?php if( has_nav_menu( 'menu-3') || ( !get_theme_mod( 'disable_header_social_links', false ) && !get_theme_mod( 'disable_mobile_social_icons_header', false ) && bosa_has_social() ) || is_active_sidebar( 'menu-sidebar' ) || ( get_theme_mod( 'header_advertisement_banner', '' ) != '' && !get_theme_mod( 'disable_mobile_ad_banner', false ) ) ){ ?>
