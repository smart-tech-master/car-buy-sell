...
$sections[] = array(
	'id' => 'example', // Required
	'title' => __( 'Example Section', 'patricia-lite' ), // Required
...
$panels[] = array(
	'id' => $panel,
	'title' => __( 'Panel Examples', 'patricia-lite' ),
	'priority' => '100'
);
...
$sections[] = array(
	'id' => $section,
	'title' => __( 'Panel Section', 'patricia-lite' ),
	'priority' => '10',
	'panel' => $panel
);
...
$options['example-panel-text'] = array(
	...
	'label'   => __( 'Example Text Input', 'patricia-lite' ),
	'section' => $section,
	'type'    => 'text',
);
~~~
...
$options['example-url'] = array(
	'id' => 'example-url',
	'label'   => __( 'Example URL Input', 'patricia-lite' ),
	'section' => $section,
	'type'    => 'url',
);
~~~
...
$options['example-checkbox'] = array(
	'id' => 'example-checkbox',
	'label'   => __( 'Example Checkbox', 'patricia-lite' ),
	'section' => $section,
	'type'    => 'checkbox',
	'default' => 0,
);
...
$options['example-select'] = array(
	'id' => 'example-select',
	'label'   => __( 'Example Select', 'patricia-lite' ),
	'section' => $section,
	'type'    => 'select',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-dropdown-pages'] = array(
	...
	'label'   => __( 'Example Drop Down Pages', 'patricia-lite' ),
	'section' => $section,
	'type'    => 'dropdown-pages',
	'default' => ''
);
...
$options['example-radio'] = array(
	'id' => 'example-radio',
	'label'   => __( 'Example Radio', 'patricia-lite' ),
	'section' => $section,
	'type'    => 'radio',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-upload'] = array(
	'id' => 'example-upload',
	'label'   => __( 'Example Upload', 'patricia-lite' ),
	'section' => $section,
	'type'    => 'upload',
	'default' => '',
);
...
$options['example-color'] = array(
	'id' => 'example-color',
	'label'   => __( 'Example Color', 'patricia-lite' ),
	'section' => $section,
	'type'    => 'color',
	'default' => $color // hex
);
...
$options['example-textarea'] = array(
	'id' => 'example-textarea',
	'label'   => __( 'Example Textarea', 'patricia-lite' ),
	'section' => $section,
	'type'    => 'textarea',
	'default' => __( 'Example textarea text.', 'patricia-lite'),
);
~~~
...
$options['example-font'] = array(
	'id' => 'example-font',
	'label'   => __( 'Example Font', 'patricia-lite' ),
	'section' => $section,
	'type'    => 'select',
...
$options['example-range'] = array(
	'id' => 'example-range',
	'label'   => __( 'Example Range Input', 'patricia-lite' ),
	'section' => $section,
	'type'    => 'range',
	'input_attrs' => array(
        'min'   => 0,
...
function patricia_lite_fonts() {
	...
	// Load Google Fonts
	wp_enqueue_style( 'patricia_lite_fonts', $font_uri, array(), null, 'screen' );

}
add_action( 'wp_enqueue_scripts', 'patricia_lite_fonts' );
~~~
