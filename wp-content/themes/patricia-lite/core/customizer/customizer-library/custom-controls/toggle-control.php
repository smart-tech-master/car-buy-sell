...
class Customizer_Toggle_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'customizer-toggle-control', get_template_directory_uri() . '/core/customizer/customizer-library/js/customizer-toggle-control.js', array( 'jquery' ), rand(), true );
		wp_enqueue_style(  'pure-css-toggle-buttons', get_template_directory_uri() . '/core/customizer/customizer-library/css/pure-css-togle-buttons.css' );
