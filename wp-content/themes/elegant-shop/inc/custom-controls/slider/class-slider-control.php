<?php
/**
 * elegant shop pro Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Elegant_Shop_Pro_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Elegant_Shop_Pro_Slider_Control extends WP_Customize_Control {

		public $type = 'elegant-shop-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'elegant-shop-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'elegant-shop-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
