<?php
/**
 * elegant shop pro Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Elegant_Shop_Pro_Control_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Elegant_Shop_Pro_Control_Repeater_Setting extends WP_Customize_Setting {
