...
if (!function_exists('feminine_business_get_svg_icons')) :
    ...
    function feminine_business_get_svg_icons()
    {
        ...
        $svg_options = array();
        $svg_options[''] = __(' -- Choose -- ', 'feminine-coach');
 ...
 * Header search
 */
function feminine_business_header_search()
{
    ...
    if ($ed_social && $social_links && $echo) { ?>
        <ul class="social-icons">
            ...
            foreach ($social_links as $link) {
                $new_tab = isset($link['fbp_pro_checkbox']) && $link['fbp_pro_checkbox'] ? '_blank' : '_self';
                if (isset($link['fbp_pro_link']) && $link['fbp_pro_link']) { ?>
                    <li>
                        <a href="<?php echo esc_url($link['fbp_pro_link']); ?>" target="<?php echo esc_attr($new_tab); ?>" rel="nofollow noopener">
                            <?php echo wp_kses(feminine_business_social_icons_svg_list($link['fbp_pro_icon']), feminine_business_get_kses_extended_ruleset()); ?>
                        </a>
                    </li>
            <?php
                }
                ...
                <div class="header-top-wrap">
                    <div class="middle-wrap">
                        ...
                        <div class="top-right">
                             ...
                             * Header Contact
                             */
                            feminine_business_header_contact();
                            ?>
                        </div>
                    ...
                    <?php if ($ed_social) { ?>
                        <div class="top-right">
                            <?php if ($ed_social) { ?>
                                 ...
                                 * Header Search
                                 */
                                feminine_business_header_search();
                                ?>
                            <?php } ?>
                        </div>
                    <?php } ?>
...
function feminine_business_google_fonts_url() {
	...
	/*
		...
		* supported by Tenor fonts, translate this to 'off'. Do not translate
		* into your own language.
	*/
	$tenorsans_font = _x( 'on', 'Tenor Sans: on or off', 'feminine-coach' );

	if ( 'off' !== $tenorsans_font ) {
		$font_families = array();

		if ( 'off' !== $tenorsans_font ) {
			$font_families[] = 'Tenor Sans:300,400,500,600i,700';
		}
		$query_args = array(
